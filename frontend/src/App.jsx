          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex justify-end">
              <h1 className="text-base font-bold text-slate-800 leading-tight">
                {currentView === 'detail' ? '基金详情' : (currentView === 'account' ? '我的账户' : (currentView === 'crypto' ? '数字货币持仓' : (currentView === 'ai-simulation' ? 'AI模拟账户' : (currentView === 'settings' ? '设置' : (currentView === 'messages' ? '消息中心' : 'FundVal Live')))))}
              </h1>
            </div>
                ...
                {currentView === 'detail' ? (
                  ...
                  <div className="flex gap-2">
                     ...
                     <button
                        ...
                        className={`p-2 rounded-lg transition-colors ${currentView === 'crypto' ? 'bg-blue-100 text-blue-700' : 'hover:bg-slate-100 text-slate-500'}`}
                     >
                        <Bitcoin className="w-6 h-6" />
                     </button>
                     <button
                        onClick={() => setCurrentView('ai-simulation')}
                        className={`p-2 rounded-lg transition-colors ${currentView === 'ai-simulation' ? 'bg-blue-100 text-blue-700' : 'hover:bg-slate-100 text-slate-500'}`}
                        title="AI模拟账户"
                     >
